...
La descripción del algoritmo desarrollado\cite{hector} queda fuera del alcance de este trabajo. En las figuras~\ref{fig:teorema1} y ~\ref{fig:teorema2} se muestran unas gráficas, cortesía de los autores del algoritmo, donde se compara la posición medidas por el robot2, mediante los Markers con la que se obtiene mediante su algoritmo, aplicando dos métodos distintos. En el segundo caso se hace uso de un estimador, los resultados son bastante aceptables, teniendo en cuenta las limitaciones del Robotario
