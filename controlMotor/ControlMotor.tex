...
De la figura~\ref{fig:respuestaEscalon} se obtiene T que es el periodo de la oscilación. Para la rueda derecha $Td=0.59 ms$ que se obtiene tomando el tiempo entre dos máximos, tal y como se aprecia en la figura~\ref{fig:respuestaescalonrd} y para la rueda izquierda se tiene $Ti=0.55 ms$ en la figura~\ref{fig:respuestaescalonri} se tienen los máximos que se han usado. El valor de la ganancia para la que se ha conseguido la oscilación permanente del sistema es de K=2. A partir de los valores anteriores se obtienen las ganancias del Cuadro~\ref{tab:PID} que corresponden a las ganancias del control P, PI y PID.\\
