...
\begin{table}[h]
	...
	\end{center}
\end{table}
Con las ganancias calculadas en el Cuadro~\ref{tab:PID} donde $K_{p}$ corresponde al control proporcional, $K_{i}$ al integral y $K_{d}$ al derivativo,  se vuelve a realizar una prueba para ver la respuesta de los motores. En la figura~\ref{fig:PI_Nichols}, se puede apreciar la respuesta de los motores, se puede ver que en el motor derecho se tiene una oscilación y el motor izquierdo llega al asentamiento pero tiene una sobre-elongación grande.
