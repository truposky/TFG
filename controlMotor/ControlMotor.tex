...
Para que el robot pueda seguir las instrucciones de manera correcta y los algoritmos se puedan efectuar de manera acertada, el robot debe incorporar un control de la velocidad de las ruedas,el cual se aplica a los dos motores DC de las ruedas motrices. En la figura ~\ref{fig:diagramabloque1}.\\
...
\begin{itemize}
	\item $U(s)$ corresponde a la consigna para la velocidad angular de la rueda ($w$). La entrada se traduce en un valor de PWM que corresponde con un valor de voltaje el cual está limitado a un valor de 6.5 V.
		\begin{figure}[!hp]
