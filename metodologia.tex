...
Se eligen los componentes necesarios para llevarlo a cabo. Estos deberán ser de fácil acceso y comunes para su fácil sustitución o reparación. Esto conllevará a que sean de bajo presupuesto. Los criterios que se siguen en la elección del hardware son los siguientes:
\begin{itemize}
...
Se realizan diversos experimentos en el robotario para comprobar el funcionamiento del mismo. Se evalúan los datos adquiridos de los experimentos, que permiten conocer las limitaciones del robotario.
