...
\subsection{Selección de componentes y software}
...
Los criterios que se siguen en la elección del software y hardware en base a los ejemplos estudiados son los siguientes:
\begin{itemize}
	\item Se debe diseñar un robot móvil, de un presupuesto razonable y que sea fácil de replicar. 
	\item Se debe seleccionar un sensor para poder estimar la velocidad a la cual se mueve el robot.
	\item Se debe elegir un microcontrolador para las tareas de bajo nivel del robot.
	\item Se debe elegir un sistema de visión a bordo del robot y un ordenador a bordo que procese los datos.
	\item Se debe conseguir un sistema de comunicación sencillo y fácil de configurar. Que pueda soportar varios dispositivos conectados.
...
\subsubsection{Encoders y estimación de la velocidad}
