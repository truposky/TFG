...
Antes de ponerse a diseñar y montar el robtoario, se estudia los ejemplos existentes, en particular el Robotarium, se ve que componentes tienen, como son los robots, como se mueven para luego intentar recrearlo, como se localizan los robots, también se lee la documentación de Duckietown y se recopila información de como lo han hecho su experiencia construyendo los robots y lo que han necesitado. Después de haber estudiado con detenimiento ejemplos existentes se plantea que se necesita para poder construir un entorno de pruebas equivalente, y se decide por realizar una comunicación inalámbrica mediante la tecnología WiFi, que es fácil de implementar y mas barata que una emisora de radio.
