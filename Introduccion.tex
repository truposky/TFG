...
\subsection{Step-Down DC-DC}
	...
	\label{fig:StepDown}
	\end{figure}
Se tiene un conversor DC-DC para bajar el voltaje de salida de la batería, en el capitulo ?? se comenta porque.También se ha adquirido en la tienda de Aliexpress[referencia]
