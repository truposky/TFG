...
\section{Introducci\'{o}n}\label{ch:introduccion}
 ...
 En este proyecto se lleva a cabo el desarrollo de un entorno de pruebas para poder verificar y recopilar datos de algoritmos multi-agente que requieran el uso de robots móviles en un entorno realista.\\
