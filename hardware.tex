...
\subsubsection{LM2596 (conversor DC-DC)}
	...
	\label{fig:StepDown}
	\end{figure}
Se emplean dos conversores DC-DC como el de la figura~\ref{fig:StepDown} para bajar el voltaje de salida de la batería, uno es para alimentar el módulo Ln298 y otro es para alimentar la raspberryPi a bordo que requiere como máximo 5V. De esta manera se evita el uso de otra batería y se separa la alimentación de la placa de Arduino y de la raspberryPi.
...
\end{itemize}
Según un análisis realizado por Red zone \cite{router} el router es más que suficiente para la situación actual del Robotario que cuenta con 3 robots construidos y pronto serán 5. Se entra en más profundidad en el análisis de las características de la red en el capítulo~\ref{ch:RedLan}.
\subsection{Software}
