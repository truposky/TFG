...
El objetivo es crear un entorno de pruebas para poder probar algoritmos colaborativos y de coordinación u otros en los cuales sea necesario el uso de robots móviles. El entorno está basado en los trabajos anteriormente mencionados de Duckietown y Robotarium. Para poder llevarlo a cabo se necesita cumplir los siguientes objetivos.
\subsubsection{{\large Objetivos específicos }}
\begin{itemize}
	\item Construir y diseñar un robot y copias del mismo, capaz de ejecutar los algoritmos requeridos por el Robotario.
	...
	\item Configurar la comunicación de los robots, para poder comunicarse con otros robots y con un servidor.
