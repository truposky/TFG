...
También es intersante aplicar un entorno que permita a la persona que quiere llevar su algoritmo una facil aplicación del mismo. Hasta ahora la manera de implementar un algoritmo se hace a bajo nivel mandando instrucciones de la velocidad a los robots.